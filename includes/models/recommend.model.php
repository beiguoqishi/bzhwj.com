...
class RecommendModel extends BaseModel
{
    ...
    function get_recommended_goods($recom_id, $num, $default_image = true, $mall_cate_id = 0, $timeslot=array(), $sort_by='') // tyioocom
    {
        ...
        else
        {
            ...
            /* 推荐商品 */
            $sql = "SELECT g.goods_id, g.goods_name,g.cate_id,g.cate_name,g.tags,g.brand,g.default_image, gs.price, gs.stock,goodsstatistics.sales,goodsstatistics.comments,s.store_id,s.im_qq,s.im_ww,s.store_name " .
    ...
    public function get_ultimate_store($limit = 20) {
	    $sql = "select store_id,store_name,store_logo from ecm_store as l inner join ecm_ultimate_store r using(store_id) limit $limit";
