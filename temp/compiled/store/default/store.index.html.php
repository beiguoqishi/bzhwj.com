...
?>
                            <li>
                                <div class="pic"><a href="<?php echo url('app=store&store_id=' . $this->_var['store']['store_id']. '&act=recommend_goods&goods_id=' . $this->_var['rgoods']['goods_id']. ''); ?>" target="_blank"><img src="<?php echo $this->_var['rgoods']['default_image']; ?>" width="150" height="150" /></a></div>
                                <h3><a href="<?php echo url('app=store&store_id=' . $this->_var['store']['store_id']. '&act=recommend_goods&goods_id=' . $this->_var['rgoods']['goods_id']. ''); ?>" target="_blank"><?php echo htmlspecialchars($this->_var['rgoods']['goods_name']); ?></a></h3>
...
?>
        ...
        <div class="module_special">
            <h2 class="common_title veins2">
                <div class="ornament1"></div>
                <div class="ornament2"></div>
                <span class="ico1"><span class="ico2">面部项目</span></span>
            </h2>
            <div class="wrap">
                <div class="wrap_child">
                    <?php if ($this->_var['face_goods']): ?>
                    <div class="major">
                        <ul class="list">
                            <?php $_from = $this->_var['face_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'ngoods');if (count($_from)):
...
?>
                            <li>
                                ...
                                <p style="text-align: center"><?php echo price_format($this->_var['ngoods']['price']); ?></p>
                                <p style="text-align: center;margin-top: 8px"><?php echo htmlspecialchars($this->_var['ngoods']['effect']); ?></p>
                            </li>
                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                        </ul>
                    </div>
        ...
        <div class="module_special">
            <h2 class="common_title veins2">
                <div class="ornament1"></div>
                <div class="ornament2"></div>
                <span class="ico1"><span class="ico2">身体项目</span></span>
            </h2>
            <div class="wrap">
                <div class="wrap_child">
                    <?php if ($this->_var['face_goods']): ?>
                    <div class="major">
                        <ul class="list">
                            <?php $_from = $this->_var['body_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'ngoods');if (count($_from)):
    foreach ($_from AS $this->_var['ngoods']):
?>
                            <li>
                                <div class="pic"><a href="<?php echo url('app=goods&id=' . $this->_var['ngoods']['goods_id']. ''); ?>" target="_blank"><img src="<?php echo $this->_var['ngoods']['default_image']; ?>" width="150" height="150" /></a></div>
