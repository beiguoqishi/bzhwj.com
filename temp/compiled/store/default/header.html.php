...
<div id="head">
    <h1 style="top:0;" title="<?php echo htmlspecialchars($this->_var['site_title']); ?>"><a href="index.php"><img style="width: 180px" src="<?php echo $this->_var['site_logo']; ?>" alt="ECMall" /></a></h1>
    ...
    <div id="subnav">
        ...
        <a class="favorite" href="<?php echo url('app=my_favorite'); ?>">收藏夹</a> <span>|</span>
            <a href="index.php?app=article&code=help" target="_blank">联系客服</a>
        <!--<a class="note" href="<?php echo url('app=message&act=newpm'); ?>">站内消息&lt;!&ndash;<?php if ($this->_var['new_message']): ?>&ndash;&gt;(<?php echo $this->_var['new_message']; ?>)&lt;!&ndash;<?php endif; ?>&ndash;&gt;</a> <span>|</span>-->
...
?>
    ...
    <div id="path">
        店铺:<span style="padding-left: 8px;color: #f30;font-size: 12px"><?php echo htmlspecialchars($this->_var['store']['store_name']); ?></span>
    </div>
