...
?><?php echo $this->_var['tag']; ?>&nbsp;&nbsp;&nbsp;<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?><br />
        ...
        <div style="padding-left: 20px">
            ...
            <?php endif; ?>
            <?php if ($this->_var['goods']['experiment']): ?>
            <a target="_blank" href="/index.php?app=appointment&store_id=<?php echo $this->_var['goods']['store_id']; ?>&goods_id=<?php echo $this->_var['goods']['goods_id']; ?>&user_id=<?php echo $this->_var['user_id']; ?>" style="text-decoration:none;margin-left:15px;padding: 8px 12px;border-radius: 3px;font-size: 14px;color: white;background:-moz-linear-gradient(top,#f00,#f00);background: -webkit-gradient(linear,0 0,0 50%,from(#f00),to(#f00));background: -o-linear-gradient(top,#f00,#f00);">预约体验</a>
            <?php endif; ?>
        </div>
