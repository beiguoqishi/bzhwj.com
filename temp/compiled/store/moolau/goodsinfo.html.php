...
?>
    ...
    <div class="ware_text">
        <div class="rate">
			...
			<?php if ($this->_var['goods_integral_info']): ?>
			可返回积分：<span style="color: #CEAA00;font-size: 14px;font-weight: bold;padding: 0 0.5em;"><?php echo ($this->_var['goods_integral_info']['has_integral'] == '') ? '0' : $this->_var['goods_integral_info']['has_integral']; ?></span>积分<br />
			<?php endif; ?>
...
?><?php echo $this->_var['tag']; ?>&nbsp;&nbsp;&nbsp;<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?><br />
        ...
        <script>
			$(function(){
				$('.handle').hover(function(){
					$(this).attr('class','handle-hover');
				},function(){
					$(this).attr('class','handle');
				});
				$('.dotted').hover(function(){
					$(this).addClass('dotted-hover');
				});
			});
		</script>
        ...
        <ul class="ware_btn">
            ...
            <li class="btn_c1" title="立刻购买"><a href="javascript:buy();"></a></li>
