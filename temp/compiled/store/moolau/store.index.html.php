...
<link href="http://www.gymdw.com/external/modules/jindan/templates/admin/zadan.css" rel="stylesheet" type="text/css" />     
<?php echo $this->_var['jindan']; ?>
...
?>
                            <li>
                                ...
                                <h3><a href="<?php echo url('app=goods&id=' . $this->_var['hsgoods']['goods_id']. ''); ?>" target="_blank"><?php echo htmlspecialchars($this->_var['hsgoods']['goods_name']); ?></a></h3>
