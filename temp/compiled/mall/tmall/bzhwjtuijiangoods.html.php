...
?>
            <li>
                <a href="<?php echo htmlspecialchars($this->_var['el']['url']); ?>" target="_self">
                    <img style="max-width: 100%" src="<?php echo htmlspecialchars($this->_var['el']['img']); ?>"><span><?php echo htmlspecialchars($this->_var['el']['title']); ?></span>
                </a>
            </li>
        ...
        <h2 class="newest-tle" style="margin-top: 30px">其它品牌</h2>
        <?php if ($this->_var['other_brands']): ?>
        <ul class="newest-list other-list">
