...
?>
          			...
          			<div class="content">
          	 			<?php if ($this->_var['brands'] || $this->_var['price_intervals'] || $this->_var['regions'] || $this->_var['categories']): ?>
...
?>
                   				<a href="javascript:void(0);" title="<?php echo $this->_var['row']['brand']; ?>" id="<?php echo urlencode($this->_var['row']['brand']); ?>"><?php echo htmlspecialchars($this->_var['row']['brand']); ?><span class="count">(<?php echo $this->_var['row']['count']; ?>)</span></a>
                   				<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                			</div>
             			</div>
            			<?php endif; ?>
    ...
    foreach ($_from AS $this->_var['row']):
?>
                   				<a href="javascript:void(0);" id="<?php echo $this->_var['row']['min']; ?> - <?php echo $this->_var['row']['max']; ?>"><?php echo price_format($this->_var['row']['min']); ?> - <?php echo price_format($this->_var['row']['max']); ?><span class="count">(<?php echo $this->_var['row']['count']; ?>)</span></a>
                   				<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                			</div>
             			</div>
             			<?php endif; ?>
...
?>
                   				<a href="javascript:void(0);" hidefocus="true" id="<?php echo $this->_var['row']['region_id']; ?>" title="<?php echo htmlspecialchars($this->_var['row']['region_name']); ?>"><?php echo htmlspecialchars($this->_var['row']['region_name']); ?><span class="count">(<?php echo $this->_var['row']['count']; ?>)</span></a>
                   				<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                			</div>
             			</div>
             			<?php endif; ?>
...
?>
             				<dl class="item clearfix dl-<?php echo $this->_var['goods']['goods_id']; ?>">
                                ...
                                <dd class="price clearfix"><em><?php echo price_format($this->_var['goods']['price']); ?></em></dd>
                				<dd class="desc"><a href="<?php echo url('app=goods&id=' . $this->_var['goods']['goods_id']. ''); ?>" target="_blank"><?php echo sub_str(htmlspecialchars($this->_var['goods']['goods_name']),66); ?></a></dd>
                                <dd class="status"><span class="sales">总销量:<b><?php echo $this->_var['goods']['sales']; ?></b></span><span class="valuation">|累计评价:<b><?php echo $this->_var['goods']['comments']; ?></b>条</span></dd>
