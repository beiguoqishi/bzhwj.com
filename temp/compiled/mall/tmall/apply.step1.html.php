...
?>
       <?php if (($this->_foreach['fe_sgrade']['iteration'] == $this->_foreach['fe_sgrade']['total'])): ?><dl class="clearfix mb10" <?php if (($this->_foreach['fe_sgrade']['iteration'] == $this->_foreach['fe_sgrade']['total'])): ?> style="border-bottom:0;"<?php endif; ?>>
       ...
       <!--<dd class="float-left">-->
           ...
           <!--<p>需要审核：<span>&lt;!&ndash;<?php if ($this->_var['sgrade']['need_confirm']): ?>&ndash;&gt;是&lt;!&ndash;<?php else: ?>&ndash;&gt;否&lt;!&ndash;<?php endif; ?>&ndash;&gt;</span></p>-->
       <!--</dd>-->
       <!--<dd class="float-left">-->
           <!--<p>附加功能：</p>-->
           <!--<p>-->
