...
?>
                 	<li class="item mb20" <?php if ($this->_foreach['fe_group']['iteration'] % 4 == 0): ?> style="margin-right:0"<?php endif; ?>>
                    	...
                    	<div class="extra">
                   			<span>折扣：<strong><?php echo $this->_var['group']['discount']; ?></strong>折</span><span>剩余时间：<?php echo $this->_var['group']['lefttime']; ?></span><span><b><?php echo $this->_var['group']['quantity']; ?></b>人参与</span>
