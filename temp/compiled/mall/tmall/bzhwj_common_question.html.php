    ...
    <div class="right">
        <div class="leftbox">
            <ul class="nav clearfix">
                <li class="cur"><a href="http://www.bzhwj.com/index.php?app=bzhwj_kefu">常见问题专栏</a></li>
                <li><a href="http://www.bzhwj.com/index.php?app=bzhwj_tuihuo">退货流程</a></li>
                <li><a href="http://www.bzhwj.com/index.php?app=bzhwj_kefu">最新公告</a> </li>
            </ul>
            ...
            <div class="next-title">
                <p><span style="margin-right: 8px">上一篇：</span><a style="color: #f30" href="/index.php?app=bzhwj_common_question&id=<?php echo $this->_var['last']['id']; ?>" target="_self"><?php echo $this->_var['last']['title']; ?><<</a></p>
                <p><span style="margin-right: 8px">下一篇：</span><a style="color: #f30" href="/index.php?app=bzhwj_common_question&id=<?php echo $this->_var['next']['id']; ?>" target="_self"><?php echo $this->_var['next']['title']; ?>>></a></p>
            </div>
        </div>
        <div class="rightbox">
