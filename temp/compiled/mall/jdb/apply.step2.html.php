        ...
        <div class="module_new_shop">
                    ...
                    <div class="info_shop">
                        ...
                        <table>
                            ...
                            <tr>
                                <td colspan="2"><p class="padding4"><input type="checkbox" <?php if ($this->_var['store']): ?> checked="checked"<?php endif; ?> name="notice" value="1" id="warning1" /> <label for="warning1">我已认真阅读并完全同意<a href="index.php?app=article&act=system&code=setup_store" target="_blank">开店协议</a>中的所有条款</label></p></td>
                                <td></td>
                            </tr>
                            <tr>
