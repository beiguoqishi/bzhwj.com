...
?>
zhanghuzongjinere<span style="font-size:16px;font-weight:bold; color:#FE5400;"><?php echo $this->_var['val']['money']; ?></span>
&nbsp;yuan&nbsp;&nbsp;&nbsp;&nbsp;dongjiejine<span style="color:blue;"><?php echo $this->_var['val']['money_dj']; ?></span>&nbsp;yuan</span><span class="epay_btn"><a href="<?php echo url('app=epay&act=txlist'); ?>" style="color:red">tixian</a></span><span class="epay_btn"><a href="<?php echo url('app=epay&act=czlist'); ?>">chongzhi</a></span>
