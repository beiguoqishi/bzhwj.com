...
<div class="channel clearfix w1000">
    <div class="cleft">
    	<div area="left" widget_type="area">
            <?php $this->display_widgets(array('page'=>'channel9','area'=>'left')); ?>
        </div>
    </div>
    ...
    <div class="cright">     
        <div class="main clearfix">
            <div class="middle" area="cycle_image" widget_type="area">
                <?php $this->display_widgets(array('page'=>'channel9','area'=>'cycle_image')); ?>
            </div>

            <div class="cside" area="sales" widget_type="area">
                <?php $this->display_widgets(array('page'=>'channel9','area'=>'sales')); ?>
            </div>
        </div>
        <div class="c_floor clearfix" area="cfloor" widget_type="area">
            <?php $this->display_widgets(array('page'=>'channel9','area'=>'cfloor')); ?>
        </div>
    </div>
</div>
