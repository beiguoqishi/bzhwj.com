            ...
            <form method="post" enctype="multipart/form-data" id="my_store_form">
                    ...
                    <div class="setup info shop">
                        ...
                        <table style="width: 100%">
                            ...
                            <tr>
                                <th>标语:</th>
                                <td><input name="store_desc" type="text" class="text width_normal" id="tel" value="<?php echo htmlspecialchars($this->_var['store']['store_desc']); ?>" /></td>
                            </tr>
                            <tr>
                                <th>工作时间:</th>
                                <td><input name="work_time" type="text" class="text width_normal" id="tel" value="<?php echo htmlspecialchars($this->_var['store']['work_time']); ?>" /></td>
                            </tr>
                            <tr>
                                <th>所在地区:</th>
                                <td><div id="region">
                            ...
                            <tr>
                                  <th>联系QQ:</th>
                                  <td><input name="im_qq" type="text" class="text" style=" width:300px;" id="im_qq" value="<?php echo htmlspecialchars($this->_var['store']['im_qq']); ?>" /><span class="field_notice">配置多个qq,用半角逗号(,)分开;qq号码和显示名称用减号(-)分开 例如：332105640-小帅哥,111112222-小马哥</span></td>
                            </tr>
                            <tr>
                                  <th>阿里旺旺:</th>
                                  <td><input name="im_ww" type="text" class="text" style=" width:300px;" id="im_ww" value="<?php echo htmlspecialchars($this->_var['store']['im_ww']); ?>" /><span class="field_notice">配置多个旺旺,用半角逗号(,)分开;旺旺登录名和显示名称用减号(-)分开 例如：tyioocom-大灰狼,andcpp-喜羊羊</span></td>
                            </tr>
                            <tr>
                                  <th>MSN在线通:</th>
