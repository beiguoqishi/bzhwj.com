...
class StoreApp extends StorebaseApp
{
    function index()
    {
        ...
        $this->assign('face_goods', $this->_get_goods_by_ctg($id,1));
        $this->assign('body_goods', $this->_get_goods_by_ctg($id,15));
    ...
    function search()
    {
        ...
        $this->assign('cur_ctg_id',intval($_GET['cate_id']));
...
//        $this->assign('article', $article);
        ...
        $store = $this->get_store_data();
        $this->assign('store', $store);
        $this->assign('face_goods', $this->_get_goods_by_ctg($store_id,1));
        $db =& db();
    ...
    function _get_goods_by_ctg($store_id,$c_id,$num = 12) {
