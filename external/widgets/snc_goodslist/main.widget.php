 ...
 * @return  array
 */
class Snc_goodslistWidget extends BaseWidget
{
    var $_name = 'snc_goodslist';
    var $_ttl  = 1800;
    var $_num  = 6;
    ...
    function _get_data()
    {
        ...
        if($data === false)
        {
            import('init.lib');
			$data = array(
			   'goodslist' =>Init_BaseWidget::_get_recom_goods($this->options['img_recom_id'],$this->_num, true, $this->options['img_cate_id']),
